...
namespace DataProcessing.MLData
{
    public class Experiment
    {
        ...
        private ColumnData CreateColumn(MetaColumn colProp)
        {
            ...
            if (colProp.Encoding.Equals(CategoryEncoding.Level.Description(),StringComparison.OrdinalIgnoreCase))
            ...
            if (colProp.Scale.Equals(Scaling.MinMax.Description(), StringComparison.OrdinalIgnoreCase))
